...
public class AmazonS3ClientServiceImpl implements AmazonS3ClientService {
	public static final String BUCKET_BASE_URL="https://mediafilesgls.s3.ap-south-1.amazonaws.com/";
    ...
    public void uploadFileToS3Bucket(MultipartFile multipartFile, boolean enablePublicReadAccess) 
    {
        ...
        this.uploadFileToS3Bucket(multipartFile, fileName, enablePublicReadAccess);
    }
	...
	public void uploadFileToS3Bucket(MultipartFile multipartFile, String filename, boolean enablePublicReadAccess) {
		 ...
		 String fileName = filename;
	        ...
	        try {
	            ...
	            lastFileName = BUCKET_BASE_URL+filename;
